...
public class Interface_cashare_StatisticsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        statisticsDAO = new StatisticsDAO(); // إنشاء كائن DAO
    ...
    @FXML
    private void onMouseExitedCard7(MouseEvent event) {
        pane7.setScaleX(1.0);
        pane7.setScaleY(1.0);
    }

    @FXML
    private void onMouseEnteredCard7(MouseEvent event) {
        pane7.setScaleX(1.05);
        pane7.setScaleY(1.05);
    }

    @FXML
    private void onMouseExitedCard8(MouseEvent event) {
        pane8.setScaleX(1.0);
        pane8.setScaleY(1.0);
    }

    @FXML
    private void onMouseEnteredCard8(MouseEvent event) {
        pane8.setScaleX(1.05);
        pane8.setScaleY(1.05);
    }
